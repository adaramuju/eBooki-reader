...
public class TTSEngine {
    ...
    OnInitListener listener = new OnInitListener() {
        ...
        public void onInit(int status) {
            ...
            if (status == TextToSpeech.ERROR) {
                Toast.makeText(EBookiApp.context, R.string.msg_unexpected_error, Toast.LENGTH_LONG).show();
            }
    ...
    public synchronized TextToSpeech getTTS(OnInitListener onLisnter) {
        ...
        synchronized (helpObject) {
            ...
            ttsEngine = new TextToSpeech(EBookiApp.context, onLisnter);
        }
    ...
    public synchronized TextToSpeech setTTSWithEngine(String engine) {
        shutdown();
        synchronized (helpObject) {
            ttsEngine = new TextToSpeech(EBookiApp.context, listener, engine);
        }
        return ttsEngine;
    }
