...
import net.autogroup.pdf.search.activity.HorizontalModeController;
...
import net.autogroup.zipmanager.ZipDialog;
...
public class ExtUtils {
    ...
    public static String readableFileSize(long size) {
        if (true) {
            return Formatter.formatFileSize(EBookiApp.context, size).replace(" ", "");
        }
        if (size <= 0)
            return "0";
